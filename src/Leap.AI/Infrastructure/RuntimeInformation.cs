...
internal static class RuntimeInformation
{
    ...
    /// <summary>Returns a string with the System.Text.Json assembly version number.</summary>
    /// <returns>A string with the System.Text.Json assembly version number.</returns>
    public static string GetSystemTextJsonVersion()
    {
        var assembly = Assembly.GetAssembly(typeof(System.Text.Json.JsonSerializer));
